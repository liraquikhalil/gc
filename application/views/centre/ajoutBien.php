...
<div class="col-sm-6" style='direction: ltr;'>
    <form class="form-horizontal" method="POST"  action=" <?= base_url('centre/postAjoutBien') ?> ">
        ...
        <div class="col-sm-5">
            <input  class="form-control" name="nbrStock" >
        </div>
        
        
        <label  class="col-sm-5 control-label" >Nombre utilise</label>
        <div class="col-sm-5">
            <input  class="form-control" name="nbrUtilise" >
        </div>
        
        
        <label  class="col-sm-5 control-label" >Nombre a reforme</label>
        <div class="col-sm-5">
            <input  class="form-control" name="nbrReforme" >
        </div>
        ...
        <div class="col-sm-5">
            <input  class="form-control" name="nbrNouv" >
        </div>
